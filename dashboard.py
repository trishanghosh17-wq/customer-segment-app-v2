...
with tab2:
    ...
    if uploaded is not None:
        ...
        if not required.issubset(data.columns):
            ...
            st.dataframe(
                view.style.background_gradient(subset=["Confidence"], cmap="RdYlGn", vmin=0, vmax=1),
...
with tab3:
    ...
    if hasattr(clf, "feature_importances_"):
        ...
        st.dataframe(coefs.style.background_gradient(cmap="RdBu", axis=None), use_container_width=True)
    else:
