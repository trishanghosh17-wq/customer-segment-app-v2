...
with tab1:
    ...
    st.markdown(
        '<span class="step-pill active">01 · RFM INPUT</span>'
        '<span class="step-pill">02 · AI CLASSIFICATION</span>'
        '<span class="step-pill">03 · ACTION PLAN</span>',
        unsafe_allow_html=True
    )
    st.write("")
    st.markdown(
        '<div class="hint-card">💡 <b>Tip:</b> Lower Recency is better. Higher Frequency and Monetary value usually indicate stronger customer value.</div>',
        unsafe_allow_html=True
    )
    st.write("")
